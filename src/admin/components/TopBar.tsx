    ...
    <header className="sticky top-0 z-20 h-[72px] border-b border-white/5 bg-[#21324a] text-slate-200">
      <div className="flex h-full items-center justify-between gap-5 px-5 sm:px-8 lg:pl-[350px] lg:pr-10">
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end gap-3">
          <button className="grid h-11 w-11 shrink-0 place-items-center rounded-lg text-slate-300 transition hover:bg-white/8 hover:text-white">
          ...
          <button className="ml-1 h-10 w-10 shrink-0 overflow-hidden rounded-full border border-[#ffb400]/70 bg-[#071c33]">
